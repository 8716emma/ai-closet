...
const CLOSER_DATA = {
  ...
  templates: {
    "캐주얼": {
      ...
      items: ["무신사 스탠다드 오버사이즈 스웨트 셔츠", "토피 와이드 데님 팬츠", "컨버스 척테일러 올스타 하이", "잔스포츠 하프파인트 백팩"],
    ...
    "꾸안꾸": {
      ...
      items: ["수아레 하프 집업 니트", "무신사 스탠다드 와이드 히든 밴딩 슬랙스", "야세 스웨이드 뮬", "아페쎄 마크 카드지갑"],
    ...
    "오피스": {
      ...
      items: ["드로우핏 오버핏 테일러드 블레이저", "폴로 랄프 로렌 옥스포드 셔츠", "지오다노 테이퍼드 슬랙스", "닥터마틴 1461 모노 3홀"],
    ...
    "트레이닝": {
      ...
      items: ["나이키 스포츠웨어 윈드러너 재킷", "언더아머 우븐 조거 팬츠", "아식스 젤 카야노 14", "뉴에라 9FORTY 볼캡"],
    ...
    "남친·여친룩": {
      ...
      items: ["마하그리드 케이블 니트", "브랜디드 크림 진 팬츠", "블런드스톤 오리지널 500 첼시부츠", "마뗑킴 로고 코팅 미니백"],
    ...
    "단정해": {
      ...
      items: ["엘무드 화이트 모크넥 니트", "플랙 스텝 크롭 데님 팬츠", "하루타 페니 로퍼", "무신사 스탠다드 레더 벨트"],
    ...
    "수트": {
      ...
      items: ["마인드브릿지 TR 테일러드 수트 재킷", "마인드브릿지 TR 슬랙스 팬츠", "락포트 에센셜 디테일 워터프루프 옥스포드", "닥스 클래식 실크 넥타이"],
    ...
    "Y2K": {
      ...
      items: ["디스이즈네버댓 아치 로고 티셔츠", "코드그라피 파라슈트 카고 팬츠", "살로몬 XT-6 어드밴스", "칼하트 WIP 에센셜 백"],
    ...
    "빈티지": {
      ...
      items: ["브라운야드 아가일 가디건", "그라미치 코듀로이 팬츠", "팀버랜드 6인치 프리미엄 부츠", "모스콧 렘토쉬 뿔테 안경"],
    ...
    "default": {
      ...
      items: ["쿠어 울 블렌드 하프넥 니트", "커버낫 와이드 치노 팬츠", "클락스 왈라비 스웨이드 메이플", "카시오 빈티지 전자시계"],
      links: "musinsa.com"
    }
  },
