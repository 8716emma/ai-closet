...
const CLOSER_DATA = {
  ...
  templates: {
    "캐주얼": {
      ...
      items: ["[상의] 무신사 스탠다드 릴렉스 핏 크루 넥 반팔 티셔츠 [화이트]", "[하의] 토피 라이트웨이트 와이드 데님 팬츠 [로우 블랙]", "[신발] 컨버스 척테일러 올스타 하이 [블랙]", "[액세서리] 잔스포츠 하프파인트 미니 백팩 [블랙]"],
    ...
    "꾸안꾸": {
      ...
      items: ["[상의] 수아레 베이직 하프 집업 니트 [오트밀]", "[하의] 무신사 스탠다드 라이트웨이트 와이드 히든 밴딩 슬랙스 [라이트 그레이]", "[신발] 야세 레더 스웨이드 뮬 [브라운]", "[액세서리] 아페쎄 매그뉴 카드 홀더 [블랙]"],
    ...
    "오피스": {
      ...
      items: ["[상의] 드로우핏 릴렉스 테일러드 블레이저 [블랙]", "[하의] 지오다노 테이퍼드 핏 링클프리 슬랙스 [다크 네이비]", "[신발] 닥터마틴 1461 모노 3홀 스무스 [블랙]", "[액세서리] 샘소나이트 레드 백팩 [차콜]"],
    ...
    "트레이닝": {
      ...
      items: ["[상의] 나이키 스포츠웨어 윈드러너 후디 재킷 [블랙/화이트]", "[하의] 나이키 스포츠웨어 클럽 플리스 조거 팬츠 [그레이]", "[신발] 아식스 젤 카야노 14 [화이트/미드나잇]", "[액세서리] 뉴에라 언스트럭쳐 볼캡 [네이비]"],
    ...
    "남친·여친룩": {
      ...
      items: ["[상의] 마하그리드 써드 로고 크루넥 맨투맨 [네이비]", "[하의] 브랜디드 1905 크림 진 [크림]", "[신발] 블런드스톤 오리지널 500 첼시부츠 [스타우트 브라운]", "[액세서리] 마뗑킴 로고 코팅 미니 토트백 [블랙]"],
    ...
    "단정해": {
      ...
      items: ["[상의] 엘무드 프리미엄 실크 모크넥 니트 [아이보리]", "[하의] 플랙 커츠 스텝 크롭 데님 팬츠 [미드 블루]", "[신발] 하루타 906 페니 로퍼 [블랙]", "[액세서리] 무신사 스탠다드 이탈리안 레더 벨트 [블랙]"],
    ...
    "수트": {
      ...
      items: ["[상의] 마인드브릿지 TR 스트레치 테일러드 수트 재킷 [다크 네이비]", "[하의] 마인드브릿지 TR 스트레치 슬랙스 팬츠 [다크 네이비]", "[신발] 락포트 에센셜 디테일 워터프루프 플레인 토 [블랙]", "[액세서리] 닥스 실크 100% 솔리드 넥타이 [네이비]"],
    ...
    "Y2K": {
      ...
      items: ["[상의] 디스이즈네버댓 아치 로고 티셔츠 [오트밀]", "[하의] 코드그라피 파라슈트 카고 팬츠 [카키]", "[신발] 살로몬 XT-6 어드밴스 [블랙]", "[액세서리] 칼하트 WIP 에센셜 크로스백 [블랙]"],
    ...
    "빈티지": {
      ...
      items: ["[상의] 브라운야드 아가일 울 카디건 [브라운]", "[하의] 그라미치 코듀로이 루즈 테이퍼드 팬츠 [모카]", "[신발] 팀버랜드 6인치 프리미엄 워터프루프 부츠 [위트]", "[액세서리] 모스콧 렘토쉬 뿔테 안경 [톨토이즈]"],
    ...
    "default": {
      ...
      items: ["[상의] 쿠어 울 블렌드 하프넥 니트 [모카]", "[하의] 커버낫 원턱 와이드 치노 팬츠 [베이지]", "[신발] 클락스 왈라비 메이플 스웨이드 [메이플]", "[액세서리] 카시오 AQ-230 빈티지 전자시계 [실버]"],
      links: "musinsa.com"
    }
  },
...
반드시 아래의 JSON 규격(형식)만을 출력해야 해. 마크다운(\`\`\`json) 등 부가 텍스트는 절대 붙이지 말고 순수 JSON 문자열만 출력해줘:
{
  ...
  "items": ["[상의] 무신사 스탠다드 릴렉스 핏 크루 넥 반팔 티셔츠 [블랙]", "[하의] 토피 2WAY 스트링 와이드 데님 팬츠 [로우 블랙]", "[신발] 나이키 에어포스 1 '07 화이트", "[액세서리] 잔스포츠 하프파인트 미니 백팩"], // (매우 중요) 검색 시 여러 개가 나오지 않도록, 실제 쇼핑몰(4910, 무신사 등)에 등록된 '정확한 풀네임(모델명/색상 포함)'으로 딱 1개의 상품만 타겟팅할 것. 반드시 [상의] 1개, [하의] 1개, [신발] 1개, [액세서리/아우터] 1개 구조로 정확하게 4개를 추천할 것.
