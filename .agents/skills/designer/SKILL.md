...
### 1. 디자인 시스템 구축
- **최우선 참조:** `design-controller.html`의 12대 글로벌 프리셋 활용. 사용자에게 해당 프리셋에서 생성된 **[AI 에이전트 시스템 프롬프트]**를 제공해 달라고 요청하거나, 해당 스타일 컨텍스트를 완벽히 반영하여 토큰을 구축한다.
...
- `INSTRUCTIONS.md`의 프로젝트 스타일 가이드와 **`TASTE-RULES.md`의 디자인 엔지니어링 규칙을 최우선으로 준수**한다. (뻔한 템플릿 금지, Pretendard 강제 적용, 고급 Vanilla CSS 애니메이션 등)
...
## 작업 완료 기준
- [ ] `design-controller.html` (또는 사용자가 제공한 프리셋 프롬프트)의 디자인 토큰 룰을 100% 흡수하고 준수했는가?
