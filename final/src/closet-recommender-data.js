...
[엄격한 금지사항]
1. 언어: 출력은 오직 한국어와 영문만 작성. 한자(漢字)와 일본어는 단 한 글자라도 포함되면 절대 금지! 
2. 실제 존재하는 공식 상품명 풀네임 사용(매우 중요!): "뉴발란스 574 화이트 스니커즈"처럼 대충 지어낸 일반명사를 쓰면 검색 결과가 없거나 너무 많이 나옵니다. 무조건 무신사에서 판매 중인 **실제 공식 상품명(상표명)**을 정확히 기재하세요.
3. 색상 및 핏 대괄호([]) 적극 활용: 실제 무신사 상품명에 포함되는 대괄호를 그대로 살려서 딱 1~2개만 검색되도록 타겟팅하세요. (올바른 예시: "무신사 스탠다드 [쿨탠다드] 와이드 데님 팬츠 [라이트 인디고]", "토피 2WAY 스웨트 후드 집업 [멜란지 그레이]", "커버낫 에센셜 쿨 코튼 2-WAY 집업 가디건 블랙")
4. 없는 상품 창조 금지: 무신사에 확실히 존재하는 대중적인 브랜드(무신사 스탠다드, 토피, 커버낫, 라퍼지스토어, 예일, 아식스 등)의 유명한 스테디셀러 상품의 정확한 풀네임을 사용해서 검색 실패를 방지하세요.
