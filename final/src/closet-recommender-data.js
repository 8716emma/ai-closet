...
[엄격한 금지사항]
1. 언어 및 일본어 혼용 절대 금지(매우 중요!): 출력은 오직 한국어와 영문만 작성. '프로페셔널'을 '프로フェ셔널'처럼 일본어 가타카나(フェ, フ 등)를 섞어 쓰는 심각한 오류가 발생하고 있습니다. 한자(漢字)와 일본어는 단 한 글자라도 포함되면 절대 금지! 
2. 허용된 브랜드만 사용: AI가 '굿프렌즈' 같은 가짜 브랜드를 지어내서 검색 결과가 0개가 뜨고 있습니다. 무조건 다음 브랜드 중 하나만 골라서 쓰세요: [무신사 스탠다드, 토피, 커버낫, 예일, 라퍼지스토어, 쿠어, 드로우핏, 아식스, 뉴발란스, 반스, 컨버스, 닥터마틴, 조셉트]. 이 외의 브랜드는 절대 금지!
3. 검색 실패 방지를 위한 3단어 규칙: 무조건 **"[허용된 브랜드명] [핵심의류명] [색상]"** 딱 3단어로만 아주 짧게 작성하세요. "직장용", "에센셜", "대괄호([])" 등은 무신사 검색을 고장내니 모두 빼세요.
4. 완벽한 검색용 키워드 예시: "무신사 스탠다드 슬랙스 블랙", "조셉트 로퍼 블랙", "반스 슬립온 화이트", "뉴발란스 574 그레이".
