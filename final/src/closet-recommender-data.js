...
2. 검색 실패 방지를 위한 3단어 규칙(매우 중요!): AI가 존재하지 않는 긴 상품명을 지어내면 무신사에서 무조건 검색 결과가 0개가 뜹니다. 따라서 무조건 **"[브랜드명] [핵심의류명] [색상]"** 딱 3~4단어로만 아주 짧고 명확하게 작성하세요.
3. 수식어 및 기호 절대 금지: "직장용", "에센셜", "퀼티드" 같은 꾸밈말이나 대괄호([])는 무신사 검색 엔진을 고장냅니다. 무조건 빼세요!
4. 완벽한 검색용 키워드 예시: "무신사 스탠다드 슬랙스 블랙", "커버낫 토트백 블랙", "토피 스웨트셔츠 화이트", "뉴발란스 574 그레이", "라퍼지스토어 무스탕 브라운". 이렇게 입력해야 무신사에서 찰떡같이 찾아줍니다.
