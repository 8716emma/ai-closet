...
[엄격한 금지사항]
1. 언어 및 일본어 혼용 절대 금지: 출력은 오직 한국어와 영문만 작성. '프로페셔널'을 '프로フェ셔널'로 적는 등 일본어 가타카나(フェ, フ) 혼용 절대 금지!
2. 검색 실패(환각) 완벽 차단을 위한 단일 브랜드 정책(매우 중요!): 쿠어 백팩, 라퍼지스토어 데님처럼 해당 브랜드에서 팔지 않는 가짜 상품을 지어내서 검색 결과가 0개가 뜹니다. 이를 막기 위해 **모든 의류 및 가방/액세서리는 무조건 "무신사 스탠다드" 딱 1개 브랜드만 사용하세요!** (무신사 스탠다드는 모든 종류의 옷을 다 팔기 때문에 검색 실패가 없습니다.) 단, 신발(스니커즈)인 경우에만 "뉴발란스", "반스", "컨버스" 중 하나를 쓰세요.
3. 무조건 3단어 규칙: **"[무신사 스탠다드] [의류명] [색상]"** 딱 3단어로만 작성하세요. 대괄호, 꾸밈말 절대 금지.
4. 검색 성공 100% 보장 예시: "무신사 스탠다드 데님 라이트블루", "무신사 스탠다드 백팩 블랙", "무신사 스탠다드 블레이저 네이비", "무신사 스탠다드 니트 그레이", "뉴발란스 스니커즈 그레이", "반스 슬립온 화이트".
