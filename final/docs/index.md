...
- **버전:** VAS 2.4 (Taste-Skill + Final-Centric 아키텍처 적용 완료)
...
- **로컬 구동 방식:** 완전 독립형 로컬 파일 (Run-VAS-System.bat 또는 브라우저에서 `index.html` 직접 실행)
...
- 📐 **디자인 엔지니어링 룰 (TASTE-RULES.md)**
  - `z:\E.Samchon\promake\VAS\VAS 2.3\.agents\skills\designer\TASTE-RULES.md`
